  ...
  with HasBoomFrontendParameters // TODO: Don't add this trait
{
  ...
  val mem_iss_unit     = Module(new IssueUnitStatic(memIssueParam, numIntIssueWakeupPorts))
  mem_iss_unit.suggestName("mem_issue_unit")
  val int_iss_unit     = Module(new IssueUnitStatic(intIssueParam, numIntIssueWakeupPorts))
