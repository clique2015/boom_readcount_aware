...
// DOC include start: BOOM Parameters
  ...
  issueParams: Seq[IssueParams] = Seq(
    IssueParams(issueWidth=2, numEntries=16, iqType=IQT_MEM.litValue, dispatchWidth=2),
    IssueParams(issueWidth=2, numEntries=16, iqType=IQT_INT.litValue, dispatchWidth=2),
    IssueParams(issueWidth=2, numEntries=16, iqType=IQT_FP.litValue , dispatchWidth=2)),
